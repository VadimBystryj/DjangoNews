...
Post.objects.get(id = 2).postCategory.add(Category.objects.get(id=5), Category.objects.get(id=8))
Post.objects.get(id = 4).postCategory.add(Category.objects.get(id=7), Category.objects.get(id=9))
